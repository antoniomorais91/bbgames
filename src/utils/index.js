...
export const registrationFormStates = [
  {
    id: "AC",
    label: "Acre",
  },
...
export const registrationFormCountries = [
  { label: "Albania", id: "AL" },
  ...
  { label: "Brasil", id: "BR" },
  { label: "British Indian Ocean Territory (the)", id: "IO" },
  ...
  { label: "Canada", id: "CA" },
  { label: "Cayman Islands (the)", id: "KY" },
  { label: "Central African Republic (the)", id: "CF" },
  { label: "Chad", id: "TD" },
  { label: "Chile", id: "CL" },
  { label: "China", id: "CN" },
  { label: "Christmas Island", id: "CX" },
  { label: "Cocos (Keeling) Islands (the)", id: "CC" },
  { label: "Colombia", id: "CO" },
  { label: "Comoros (the)", id: "KM" },
  { label: "Congo (the Democratic Republic of the)", id: "CD" },
  { label: "Congo (the)", id: "CG" },
  { label: "Cook Islands (the)", id: "CK" },
  ...
  { label: "Dominican Republic (the)", id: "DO" },
  { label: "Ecuador", id: "EC" },
  { label: "Egypt", id: "EG" },
  ...
  { label: "Falkland Islands (the) [Malvinas]", id: "FK" },
  { label: "Faroe Islands (the)", id: "FO" },
  { label: "Fiji", id: "FJ" },
  { label: "Finland", id: "FI" },
  { label: "France", id: "FR" },
  { label: "French Guiana", id: "GF" },
  { label: "French Polynesia", id: "PF" },
  { label: "French Southern Territories (the)", id: "TF" },
  { label: "Gabon", id: "GA" },
  { label: "Gambia (the)", id: "GM" },
  { label: "Georgia", id: "GE" },
  { label: "Germany", id: "DE" },
  { label: "Ghana", id: "GH" },
  ...
  { label: "Korea (the Democratic People's Republic of)", id: "KP" },
  { label: "Korea (the Republic of)", id: "KR" },
  { label: "Kuwait", id: "KW" },
  { label: "Kyrgyzstan", id: "KG" },
  { label: "Lao People's Democratic Republic (the)", id: "LA" },
  { label: "Latvia", id: "LV" },
  { label: "Lebanon", id: "LB" },
  { label: "Lesotho", id: "LS" },
  { label: "Liberia", id: "LR" },
  ...
  { label: "Mali", id: "ML" },
  { label: "Malta", id: "MT" },
  { label: "Marshall Islands (the)", id: "MH" },
  ...
  { label: "Moldova (the Republic of)", id: "MD" },
  { label: "Monaco", id: "MC" },
  ...
  { label: "Peru", id: "PE" },
  { label: "Philippines (the)", id: "PH" },
  { label: "Pitcairn", id: "PN" },
  { label: "Poland", id: "PL" },
  { label: "Portugal", id: "PT" },
  { label: "Puerto Rico", id: "PR" },
  { label: "Qatar", id: "QA" },
  { label: "Republic of North Macedonia", id: "MK" },
  { label: "Romania", id: "RO" },
  { label: "Russian Federation (the)", id: "RU" },
  { label: "Rwanda", id: "RW" },
  { label: "Réunion", id: "RE" },
  ...
  { label: "Turks and Caicos Islands (the)", id: "TC" },
  { label: "Tuvalu", id: "TV" },
  { label: "Uganda", id: "UG" },
  { label: "Ukraine", id: "UA" },
  { label: "United Arab Emirates (the)", id: "AE" },
  {
    label: "United Kingdom of Great Britain and Northern Ireland (the)",
    id: "GB",
  },
  { label: "United States Minor Outlying Islands (the)", id: "UM" },
  { label: "United States of America (the)", id: "US" },
  { label: "Uruguay", id: "UY" },
